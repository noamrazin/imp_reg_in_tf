...
from common.evaluation.metrics import ReconstructionErrorMetric
...
class TensorEvaluator(Evaluator):
    ...
    def __init__(self, model: TensorFactorization, target_tensor: torch.Tensor, device=module_utils.get_device()):
        self.model = model
