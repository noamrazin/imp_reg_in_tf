...
from tensor_factorization.models.tensor_factorizations import TensorCPFactorization, LargeScaleTensorCPFactorization
...
class CPFactorNorm(AveragedMetric):
    ...
    def _calc_metric(self, cp: TensorCPFactorization):
        factors = cp.factors
...
class CPFactorColNorm(AveragedMetric):
    ...
    def _calc_metric(self, cp: Union[TensorCPFactorization, LargeScaleTensorCPFactorization]):
        factors = cp.factors
        factor = factors[self.factor_index]
