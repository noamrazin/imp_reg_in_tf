...
class Checkpoint(Callback):
    ...
    def __init__(self, output_dir: str, create_dir: bool = True, save_interval: int = 1, n_saved: int = 1,
        ...
        self.checkpoints_dir = os.path.join(self.output_dir, Checkpoint.FOLDER_NAME)
