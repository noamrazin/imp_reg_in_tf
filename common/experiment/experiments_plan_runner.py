...
class ExperimentsPlanRunner:
    ...
    def run(self, plan_config_path: str, experiment: Experiment, disable_console_log: bool = False, save_logs: bool = False,
        ...
        tuner = Tuner(experiment, context=context, largest=experiments_plan.largest, logger=logger)
        tuner.preset_options_search(configurations_seq, repetitions=experiments_plan.repetitions)
